...
<head>
    ...
    <title>Home | Yellya-Shopping</title>
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                ...
                <li><a href="#"><i class="fa fa-envelope"></i> yellya@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Yellya</span>-shopping</h2>
              <p>Famous Shopping Center, which is located in Gampaha area, very busy place and has been well-known for selling clothing.</p>
            </div>
          </div>
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>Yellya Shopping Center,<br>A1 Road,<br>Gampaha,<br>Sri Lanka.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-right">Designed by <span><a target="_blank" href="#">Alpha</a></span></p>
        </div>
      </div>
    </div>
...
<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>js/addqtocart.js"></script>
 <script type="text/javascript">
