                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a href="https://bit.ly/2LPn9Wu">Alpha</a></p>
                        </div>
                    </div> 
                  </div>
                  <!-- end login panel -->
                                     ...
                                     <div class="panel-body">
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                           <small><p>Note<br>
                                            Password must be atleast 8 to 15 characters. Only letter, numeric digits, underscore and first character must be a letter.</p></small>
                                         </div> 
                                        </div>
                                      </div> 
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
                                                "+94 00 00 000 00" type="number" value="">
                                          </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p><input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>I agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITIONS</b></a> of Yellya Shopping Center.</small>
